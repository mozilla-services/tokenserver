...
_ISTRUSTEDISSUER = descriptor.Descriptor(
  name='IsTrustedIssuer',
  full_name='IsTrustedIssuer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='hostname', full_name='IsTrustedIssuer.hostname', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='issuer', full_name='IsTrustedIssuer.issuer', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='trusted_secondaries', full_name='IsTrustedIssuer.trusted_secondaries', index=2,
...
DESCRIPTOR.message_types_by_name['IsTrustedIssuer'] = _ISTRUSTEDISSUER
...
class IsTrustedIssuer(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ISTRUSTEDISSUER
  
  # @@protoc_insertion_point(class_scope:IsTrustedIssuer)
